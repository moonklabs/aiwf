---
description: Feature development workflow with traditional or TDD approaches
...
> **💡 장시간 세션 패턴 권장**: 복잡한 기능 개발은 `/workflows:long-running-session` 워크플로우와 함께 사용하세요.
> 이중 에이전트 패턴을 통해 세션 간 컨텍스트를 유지하고 점진적으로 진행할 수 있습니다.
