...
description: Restore development context from previous session
---

> ⚠️ **Deprecation Notice**: 이 명령어는 `/aiwf:restore`로 대체됩니다.
> 세션 복구 시에는 `/aiwf:restore` 명령어를 사용하세요.
> 이 명령어는 하위 호환성을 위해 유지되며, `/aiwf:restore`에서 내부적으로 참조됩니다.
>
> **권장 명령어:**
> - 세션 복구: `/aiwf:restore`
> - 세션 시작: `/aiwf:session-start`
> - 세션 종료: `/aiwf:session-end`
